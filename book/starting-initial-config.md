...
<aside class="tip">
[Download the DAILY BUILD of QGroundControl](http://qgroundcontrol.org/downloads) and follow the video instructions below to set up your vehicle. See the [QGroundControl Tutorial](qgroundcontrol-intro.md) for details on mission planning, flying and parameter setting. 
</aside>
