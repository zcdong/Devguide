...
<aside class="tip">
To just run a few quick commands or test an application connecting to the USB shell is sufficient. The hardware serial console is only needed for boot debugging or when USB should be used for MAVLink to connect a [GCS](qgroundcontrol-intro.md).
</aside>
